    ...
    <Layout>
      ...
      >
        <div className={classNames(style.content_1060, style.cases_container)}>
          ...
          <div className={classNames(style.section, style.cases_box)}>
            ...
            <div className={style.case} onClick={e => showCase(e)}>
              ...
              >
                ...
                <p className={style.case_p}>
                  ...
                  <br /> &ensp; And the service they provide to their customers
                  is in some way similar to what you’re going to offer to your
                  customers.
                  <br /> &ensp; So the main question is: How to build a good
                  product to increase the chances for succes?
                  <br /> &ensp; We can study their products and business models
                  to find out in which way to make your product
                </p>
                <div
                  className={classNames(
                    style.case_description_btn,
