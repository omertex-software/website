...
export default () => {
  ...
  //   e.currentTarget.className === style.show_questions
  ...
  return (
    <Layout>
      ...
      >
        <div
          className={classNames(
            containers.content_1060,
            style.ceo_guide_container
          )}
        >
          <div className={containers.align_center}>
            <img src={pdf} alt="PDF icon" />
            <h2 className={style.body_1}>
      ...
      >
        <div className={containers.content_1060}>
      ...
      <section className={classNames(containers.section, style.cases)}>
        <div
          className={classNames(containers.section, containers.justify_center)}
        >
          <div className={containers.content_1060}>
        ...
        >
          <div className={containers.content_1060}>
            <div className={classNames(containers.section, style.cases_box)}>
              <div className={style.case} onClick={e => showCase(e)}>
                ...
                >
                  ...
                  <p className={style.body_5}>
                    ...
                    <br /> &ensp; Sooner or later the necessity to increase
                    revenue becomes vital for every growing business.
              ...
              <div className={style.case} onClick={e => showCase(e)}>
                ...
                >
                  ...
                  <p className={style.body_5}>
                    ...
                    <br /> &ensp; And the service they provide to their
                    customers is in some way similar to what you’re going to
                    offer to your customers.
                    <br /> &ensp; So the main question is: How to build a good
                    product to increase the chances for succes?
                    <br /> &ensp; We can study their products and business
                    models to find out in which way to make your product
                  </p>
                  <div
                    className={classNames(
                      style.case_description_btn,
              ...
              <div className={style.case} onClick={e => showCase(e)}>
                ...
                >
                  <h6 className={style.body_4}>You have a startup idea</h6>
                  <p className={style.body_5}>
                    &ensp; It’s not clear does it worth to invest into it.
                    <br /> &ensp; The development of a new software product is
                    rather expensive but the uncertantiy it will succes is so
                    high.
                  </p>
                  <div
                    className={classNames(
      ...
      >
        ...
        <div className={classNames(containers.content_1060, containers.flex)}>
